var mainState = {
    preload: function() { 
		...
		game.load.image('ninja', '../img/assets/ninja.png');
		game.load.image('block', '../img/assets/block.png');
		game.load.image('invis', '../img/assets/invis.png');
		game.load.audio('jump', '../img/assets/jump.wav');
		game.load.image('button', '../img/assets/play.png');
		game.load.image('ground', '../img/assets/ground.png');
		game.load.spritesheet('red', '../img/assets/red.png');
		game.load.spritesheet('green', '../img/assets/green.png');
		game.load.spritesheet('blue', '../img/assets/blue.png');
    },
